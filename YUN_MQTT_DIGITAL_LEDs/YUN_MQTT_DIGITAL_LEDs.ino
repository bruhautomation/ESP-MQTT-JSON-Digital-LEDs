...
Made compatible to Arduino Yün by: Arttu Mahlakaarto
...
#define mqtt_server "xxx" // Enter your MQTT server adderss or IP. I use my DuckDNS adddress (yourname.duckdns.org) in this field
#define mqtt_user "xxx" //enter your MQTT username
#define mqtt_password "xxx" //enter your password
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (String(topic) == setpowersub) {
    ...
    Console.println("Set Power: " + setPower);
    if (setPower == "OFF") {
  ...
  if (String(topic) == seteffectsub) {
    ...
    Console.println("Set Effect: " + setEffect);
    setPower = "ON";
    client.publish(setpowerpub, "ON");
  ...
  if (String(topic) == setbrightness) {
    ...
    Console.println("Set Brightness: " + setBrightness);
...
//    Console.println("Set Color Temperature: " + setColorTemp);
//    setPower = "ON";
//    client.publish(setpowerpub, "ON");
//  }
  ...
  if (String(topic) == setcolorsub) {
    ...
    Console.println("Set Color: " + setColor);
    setPower = "ON";
    client.publish(setpowerpub, "ON");
    }
...
void loop() {
  ...
  if (setEffect == "Lightning") {
    ...
    Console.println(twinklecounter);
    if (twinklecounter < 2) {
      FastLED.clear();
      FastLED.show();
    }
